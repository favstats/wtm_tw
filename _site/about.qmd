...
與[Who Targets Me](https://whotargets.me/)合作，我們致在監控`r read_lines("../n_advertisers.txt")`的政治廣告，以更深入了解競選活動如何利用Meta提供的不同定向方法。為此，我們使用了來自[Meta Ad Library](https://www.facebook.com/ads/library/)的數據，利用受眾數據揭示政治粉專如何利用定向廣告。

為了更深入了解選舉情況，我們僅保留了以下廣告商：

1. 過去7天有投放廣告的 (`r last7days_string`)
2. 過去30天有投放廣告的 (`r last30days_string`)
...
::: {.callout-note}
Meta Ad Library 僅提供7、30和90天的定向數據窗口。Meta的數據會有幾天的延遲。報告將在有新數據時進行更新。
  ...
  div(
    ...
    div(
      ...
      div(  # Wrapped the image in another div to center it horizontally
        ...
        img(
          class = "card-img", 
          src = "https://www.uva.nl/binaries/_ht_1697548401777/content/documents/personalpages/h/o/j.c.ho/j.c.ho",
          style = "max-width: 500px;"  # Adjusted max-width to control image size
        )
      )
    ),
    div(
      ...
      div(
        ...
        p(
          class = "card-text", 
          "Justin Chun-ting Ho is a Postdoc at the University of Amsterdam. His work focuses on social media and computational social science methods."
        )
      )
    )
  )
