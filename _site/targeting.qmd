---
title: "針對每個目標受眾的花費 (Spending by Targeting)"
...
這些圖表展示政黨在選舉前，根據最新數據，針對哪些群體進行廣告投放。由於Meta平台（Facebook和Instagram）提供了最詳細的政治廣告定向選項，我們探討上述平台上的廣告，

政黨的競選活動在不同目標受眾上花費了多少？以下圖表顯示了總支出和每個政黨的支出。
